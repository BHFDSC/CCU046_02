...
data = [
    ['deaths',  dbc_old, f'deaths__archive',            tmp_archived_on, 'DEC_CONF_NHS_NUMBER_CLEAN_DEID', 'REG_DATE_OF_DEATH']
  , ['gdppr',   dbc_old, f'gdppr__archive',             tmp_archived_on, 'NHS_NUMBER_DEID',                'DATE']
  , ['gdppr_1st',   dbc_old, f'gdppr__archive',             '2020-11-23', 'NHS_NUMBER_DEID',                'DATE']
...
#  , ['vacc',    dbc, f'vaccine_status_{db}_archive',    tmp_archived_on, 'PERSON_ID_DEID',                 'DATE_AND_TIME']
  , ['sgss',    dbc_old, f'sgss__archive',    '2024-09-02', 'PERSON_ID_DEID',                 'Specimen_Date']
  , ['hes_cc',  dbc_old, f'hes_cc_all_years_archive',       tmp_archived_on, 'PERSON_ID_DEID',                 'CCSTARTDATE']   
  , ['sus',     dbc_old, f'sus__archive',               '2022-09-30',    'NHS_NUMBER_DEID',                'EPISODE_START_DATE']     
  , ['chess',   dbc_old, f'chess__archive',             '2024-09-02', 'PERSON_ID_DEID',                 'InfectionSwabDate']       
