...
# MAGIC %md # CCU046_01-D03b-curated_data_lsoa
# MAGIC
...
# MAGIC
# MAGIC **Data Output**
# MAGIC - **`ccu046_01_cur_lsoa_region_lookup`** : Region lookup for LSOA codes
# MAGIC - **`ccu046_01_cur_lsoa_imd_lookup`** : IMD lookup for LSOA codes
...
save_table(df=tmpg8, out_name=f'{proj}_cur_lsoa_region_lookup', save_previous=True)

# COMMAND ----------

new = spark.table(f'{dsa}.ccu046_01_cur_lsoa_region_lookup')
display(new)
...
save_table(df=ltmp1, out_name=f'{proj}_cur_lsoa_imd_lookup', save_previous=True)