#
# NSTEMI: 30-day mortality: Key models 
# - (complete cases on demographics, timing and co-morbidities only)
#
# K. Fleetwood
# 13 Jan 2025: Adapted from 10a
#
...
# 4.5 Model 4 (binary SMI) + interaction ---------------------------------------
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "10b_mort_nstemi_30day_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "10b_mort_nstemi_30day_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "10b_mort_nstemi_30day_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "10b_mort_nstemi_30day_anova_int.csv")
) 
