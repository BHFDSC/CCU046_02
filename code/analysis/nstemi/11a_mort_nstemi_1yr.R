#
# NSTEMI: 1-year mortality: Key models (complete cases)
#
# K. Fleetwood
# 20 Jan 2025: Adapted from 10a
#
...
outcome_folder <- file.path(ccu046_02_folder, "processed_data_nstemi_1yr")
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "11a_mort_nstemi_1yr_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "11a_mort_nstemi_1yr_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "11a_mort_nstemi_1yr_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "11a_mort_nstemi_1yr_anova_int.csv")
) 
