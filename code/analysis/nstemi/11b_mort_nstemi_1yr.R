#
# NSTEMI: 1-year mortality: Key models 
# - (complete cases on demographics, timing and co-morbidities only)
#
# K. Fleetwood
# 14 Jan 2025: Adapted from 10b
#
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "11b_mort_nstemi_1yr_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "11b_mort_nstemi_1yr_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "11b_mort_nstemi_1yr_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "11b_mort_nstemi_1yr_anova_int.csv")
) 