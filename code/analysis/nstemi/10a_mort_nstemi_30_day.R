#
# NSTEMI: 30-day mortality: Key models (complete cases)
#
# K. Fleetwood
...
outcome_folder <- file.path(ccu046_02_folder, "processed_data_nstemi_30_day")
...
mod_5_bin_out <- glmer_out(mod_5_bin)
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "10a_mort_nstemi_30day_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "10a_mort_nstemi_30day_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "10a_mort_nstemi_30day_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "10a_mort_nstemi_30day_anova_int.csv")
) 
