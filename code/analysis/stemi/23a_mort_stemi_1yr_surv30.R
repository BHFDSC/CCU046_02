#
# STEMI: 1-year mortality (amongst people who survived 30 days)
# Key models (complete cases)
#
# K. Fleetwood
# 20 Jan 2025: Adapted from 21a
#
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "23a_mort_stemi_1yr_surv30_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "23a_mort_stemi_1yr_surv30_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "23a_mort_stemi_1yr_surv30_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "23a_mort_stemi_1yr_surv30_anova_int.csv")
) 