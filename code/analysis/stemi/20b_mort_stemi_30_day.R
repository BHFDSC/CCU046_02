#
# STEMI: 30-day mortality: complete cases on demographics, timing and comorbidities only
#
# K. Fleetwood
# 17 Jan 2025: Adapted from 20a
#
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "20b_mort_stemi_30day_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "20b_mort_stemi_30day_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "20b_mort_stemi_30day_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "20b_mort_stemi_30day_anova_int.csv")
) 