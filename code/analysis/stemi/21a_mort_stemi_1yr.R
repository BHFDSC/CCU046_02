...
# Calcualte mean and SD for continuous variables
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "21a_mort_stemi_1yr_mod1to5.csv")
)
write.csv(
  anova_1to5, 
  file.path(outcome_folder, "21a_mort_stemi_1yr_anova1to5.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "21a_mort_stemi_1yr_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "21a_mort_stemi_1yr_anova_int.csv")
) 