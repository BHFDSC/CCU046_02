#
# STEMI: 1-year mortality: Key models
# - (complete cases on demographics, timing and  co-morbidities only)
#
# K. Fleetwood
# 22 Jan 2025: Adapted from 21b
#
...
outcome_folder <- file.path(ccu046_02_folder, "processed_data_stemi_1yr_surv30")
...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "23b_mort_stemi_1yr_surv_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "23b_mort_stemi_1yr_surv_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "23b_mort_stemi_1yr_surv30_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "23b_mort_stemi_1yr_surv30_anova_int.csv")
) 
