...
write.csv(
  mod_out, 
  file = file.path(outcome_folder, "24b_mort_stemi_surv_mod1to4.csv")
)
write.csv(
  anova_1to4, 
  file.path(outcome_folder, "24b_mort_stemi_surv_anova1to4.csv")
)
...
write.csv(
  mod_out_int, 
  file = file.path(outcome_folder, "24b_mort_stemi_surv_mod_int.csv")
)
...
write.csv(
  anova_int,
  file = file.path(outcome_folder, "24b_mort_stemi_surv_anova_int.csv")
) 